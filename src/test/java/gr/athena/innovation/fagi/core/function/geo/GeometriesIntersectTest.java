...
public class GeometriesIntersectTest {
    ...
    public void testEvaluate() {
        ...
        String wktB2 = "LINESTRING(23.6896133 37.9630121, 23.6980247 37.9552973, 23.7225723 37.9374285)";

        GeometriesIntersect instance = new GeometriesIntersect();
        boolean expResult1 = true;
        boolean result = instance.evaluate(wktA1, wktB2);

        assertEquals(expResult1, result);

      
        String wktA3 = "LINESTRING(23.6868668 37.9432499, 23.6968231 37.9470403, 23.7181091 37.9616587)";
        String wktB4 = "LINESTRING(23.6966515 37.9360746, 23.7072945 37.9427084, 23.7199974 37.9527256)";
        
        boolean expResult2 = false;
        boolean result2 = instance.evaluate(wktA3, wktB4);
