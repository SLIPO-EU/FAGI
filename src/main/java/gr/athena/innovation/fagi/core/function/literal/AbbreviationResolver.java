...
public class AbbreviationResolver{
     ...
     * 
     * The method does not check the validity of the abbreviation, as this is considered done in previous steps.
     * If it fails to match the known abbreviations, it gets transformed to contain only 
     * word characters and the recovery is tried upon the given text.
     * 
